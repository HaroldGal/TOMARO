...
class Site:
	...
	def __init__(self, nom, nb_foyer):
		...
		liste_foyer = self.init_liste_foyer(nb_foyer)

		#Initialisaiton de la liste des productions
		liste_production = self.init_liste_production()

		#Initialisation de la liste des stockages
		liste_stockage = self.init_liste_stockage()
			...
			for foyer in liste_foyer:
				for personne in foyer.liste_personne:
					...
					if(minute in personne.tv_h_jt):
						...
						if(minute<360):
							personne.allumage_tv_h = minute + randrange(0,360-personne.tv_h_jt[minute]) #plage + rand(0,180-temps_allumage)
						else:
							personne.allumage_tv_h = minute + randrange(0,180-personne.tv_h_jt[minute]) #plage + rand(0,180-temps_allumage)
						personne.eteignage_tv_h = personne.allumage_tv_h + personne.tv_h_jt[minute] 

					if(minute in personne.pc_h_jt):
						#Si on est entre 0h et 6h 
						if(minute<360):
							personne.allumage_pc_h = minute + randrange(0,360-personne.pc_h_jt[minute]) #plage + rand(0,180-temps_allumage)
						else:
							personne.allumage_pc_h = minute + randrange(0,180-personne.pc_h_jt[minute]) #plage + rand(0,180-temps_allumage)
						personne.eteignage_pc_h = personne.allumage_pc_h + personne.pc_h_jt[minute]

					if(minute in personne.pai_h_jt):
						#Si on est entre 0h et 6h 
						if(minute<360):
							personne.allumage_pai_h = minute + randrange(0,360-personne.pai_h_jt[minute]) #plage + rand(0,180-temps_allumage)
						else:
							personne.allumage_pai_h = minute + randrange(0,180-personne.pai_h_jt[minute]) #plage + rand(0,180-temps_allumage)
			...
			for foyer in liste_foyer:
				for personne in foyer.liste_personne:
					...
					if(minute in personne.tv_h_jnt):
						#Si on est entre 0h et 6h 
						if(minute<360):
							personne.allumage_tv_h = minute + randrange(0,360-personne.tv_h_jnt[minute]) #plage + rand(0,180-temps_allumage)
						else:
							personne.allumage_tv_h = minute + randrange(0,180-personne.tv_h_jnt[minute]) #plage + rand(0,180-temps_allumage)
						personne.eteignage_tv_h = personne.allumage_tv_h + personne.tv_h_jnt[minute] 

					if(minute in personne.pc_h_jnt):
						#Si on est entre 0h et 6h 
						if(minute<360):
							personne.allumage_pc_h = minute + randrange(0,360-personne.pc_h_jnt[minute]) #plage + rand(0,180-temps_allumage)
						else:
							personne.allumage_pc_h = minute + randrange(0,180-personne.pc_h_jnt[minute]) #plage + rand(0,180-temps_allumage)
						personne.eteignage_pc_h = personne.allumage_pc_h + personne.pc_h_jnt[minute]

					if(minute in personne.pai_h_jnt):
						#Si on est entre 0h et 6h 
						if(minute<360):
							personne.allumage_pai_h = minute + randrange(0,360-personne.pai_h_jnt[minute]) #plage + rand(0,180-temps_allumage)
						else:
							personne.allumage_pai_h = minute + randrange(0,180-personne.pai_h_jnt[minute]) #plage + rand(0,180-temps_allumage)
