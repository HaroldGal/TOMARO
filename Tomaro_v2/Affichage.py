...
def menu(fenetre,nom_site,date,degre,vent,localisation,nb_foyer,nb_personne,consommation_totale,production_eo,production_pv,production_totale,stockage):	
	background = pygame.image.load("Image/Background_menu.png").convert()
...
def affichage_liste_foyer(fenetre):
