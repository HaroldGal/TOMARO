...
class Sun:
    ...
    def getSunriseTime( self, coords, day, month, year):
        return self.calcSunTime( coords, True, day, month, year)

    def getSunsetTime( self, coords, day, month, year):
        return self.calcSunTime( coords, False, day, month, year)

    def getCurrentUTC( self ):
        now = datetime.datetime.now()
        return [ now.day, now.month, now.year ]

    def calcSunTime( self, coords, isRiseTime, day, month, year, zenith = 90.8):
